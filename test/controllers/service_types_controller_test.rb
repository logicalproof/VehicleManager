...
class ServiceTypesControllerTest < ActionController::TestCase
  ...
  test "should create service_type" do
    assert_difference('ServiceType.count') do
      post :create, service_type: { mileage_interval: @service_type.mileage_interval, month_interval: @service_type.month_interval, name: @service_type.name }
    end
  ...
  test "should update service_type" do
    patch :update, id: @service_type, service_type: { mileage_interval: @service_type.mileage_interval, month_interval: @service_type.month_interval, name: @service_type.name }
    assert_redirected_to service_type_path(assigns(:service_type))
  end
